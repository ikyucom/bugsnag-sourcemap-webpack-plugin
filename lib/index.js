...
var BugsnagSourceMapPlugin = function () {
  function BugsnagSourceMapPlugin(_ref) {
    var apiKey = _ref.apiKey,
        ...
        _ref$removeSourceMap = _ref.removeSourceMap,
        removeSourceMap = _ref$removeSourceMap === undefined ? true : _ref$removeSourceMap;
  ...
  _createClass(BugsnagSourceMapPlugin, [{
    ...
    value: function apply(compiler) {
      ...
      if (compiler.hooks && compiler.hooks.afterEmit && typeof compiler.hooks.afterEmit.tap === 'function') {
        // webpack 4
        compiler.hooks.afterEmit.tap('BugsnagSourceMapPlugin', function (compilation, callback) {
    ...
    value: function uploadSourceMap(sourceFile, sourceMap, compilation) {
      ...
      request.end(function (err) {
        ...
        if (_this3.removeSourceMap) {
          _fs2.default.unlinkSync(sourceMapPath);
        }
      });
    }
  }], [{
